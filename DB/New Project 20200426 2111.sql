...
INSERT INTO `product` (`ID`,`NAME`,`DESCRIPTION`,`FILE_IMG_URL`,`STATUS`,`REMARK`,`PRICE`,`UNIT`,`AMOUNT`,`cate_id`,`region_id`) VALUES 
 (1,'Mì xào giòn','<p>asdfasfsfdasfsfasdf&nbsp; asdfasdf</p>','','Active','',1000000,'km',100,11,11),
 (2,'Máy lạnh','<p>sdafasffasdasfdasfd afsasdfasf</p>','','Active','',1000000,'cái',100,12,11);
