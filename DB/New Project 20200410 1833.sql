...
INSERT INTO `employee` (`employee_id`,`position_employee_id`,`loginname`,`sankey`,`encryptpass`,`start_date`,`address`,`country`,`contact_person`,`contact_email`,`salary`,`status`,`remark`,`ipAddress`,`last_login`,`first_name`,`last_name`,`region_id`) VALUES 
 (1,1,'admin','1568394738','qgL+XJelKMRK+cm8pCWBng==','2020-03-01 16:52:45','536/43/56 P.10 Q.tan binh','hcm','0932688659','linkthuy9@gmail.com',8000000,'Active','','192.168.1.29','2020-03-01 16:52:45','Đào','Anh Vũ',11),
...
CREATE TABLE `paypment_order` (
  ...
  `PAYPAL_TXN_FEE` varchar(12) DEFAULT NULL,
  `PAYPAL_RECEIPT_NO` varchar(100) DEFAULT NULL,
  `REMARK` varchar(200) DEFAULT NULL,
  `STATUS` varchar(12) DEFAULT NULL,
  `PAYEE_INFO` varchar(200) DEFAULT NULL,
  `PURCHASE_INFO` varchar(200) DEFAULT NULL,
  `GEN_MSG_KEY` varchar(300) DEFAULT NULL,
  `RETURN_MSG_KEY` varchar(300) DEFAULT NULL,
...
INSERT INTO `region` (`region_id`,`name_vi`,`name_en`,`status`,`remark`,`file_url_img`) VALUES 
