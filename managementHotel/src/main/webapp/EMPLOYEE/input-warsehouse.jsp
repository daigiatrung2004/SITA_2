...
<div class="taskbar" style="min-height: 50px;">
    <ul>
        ...
        <li><a href="Warehouse?type=in" class="activeWarhouse" style="color: #424242;font-weight: unset!important;opacity: 0.5;font-size: 16px;">Nhập kho</a></li>
