...
<div class="container">
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; max-height: 100px; margin: 0 auto;" src="./img/EMM_hotels.jpg" alt="Victoria Hotels and Resorts Logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                ...
                See more at
                <a href="/www.emmhotels.com" target="_blank" rel="noopener noreferrer">www.emmhotels.com</a>
            </div>
        </div>
    </div>
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; max-height: 100px; margin: 0 auto;" src="./img/Mai-Chau-Lodge_Logo.jpg" alt="Mai Chau Lodge Logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                <p style="font-size: 13pt;">
                ...
                See more at
                <a href="http://www.maichaulodge.com" target="_blank" rel="noopener noreferrer">www.maichaulodge.com</a>
            </div>
        </div>
    </div>
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; max-height: 100px; margin: 0 auto;" src="./img/Emeraude_logo.jpg" alt="Emeraude logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                <p style="font-size: 13pt;">
                ...
                See more at
                <a href="http://emeraude-cruises.com/" target="_blank" rel="noopener noreferrer"> www.emeraude-cruises.com </a>
            </div>
        </div>
    </div>
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; max-height: 100px; margin: 0 auto;" src="./img/Lazalee-cruise_logo.jpg" alt="Lazalee cruise logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                <p style="font-size: 13pt;">
                ...
                See more at
                <a href="http://www.lazaleecruises.vn" target="_blank" rel="noopener noreferrer">www.lazaleecruises.vn</a>
            </div>
        </div>
    </div>
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; max-height: 100px; margin: 0 auto;" src="./img/Hai_Au_Logo.jpg" alt="Hai Au Logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                <p style="font-size: 13pt;">
                ...
                See more at
                <a href="http://www.seaplanes.vn" target="_blank" rel="noopener noreferrer">www.seaplanes.vn</a>
            </div>
        </div>
    </div>
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; max-height: 100px; margin: 0 auto;" src="./img/Buffalo_logo.jpg" alt="Buffalo logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                <p style="font-size: 13pt;">
                ...
                See more at
                <a href="http://www.buffalotours.com" target="_blank" rel="noopener noreferrer">www.buffalotours.com</a>
            </div>
        </div>
    </div>
    <div class="uk-grid uk-grid-collapse" style="padding: 20px; margin-bottom: 10px; background-color: white;">
        <div class="uk-width-medium-1-6" style="padding: 10px 0; display: flex; justify-content: center; flex-direction: column;">
            <img style="max-width: 150px; margin: 0 auto;" src="./img/VMK_Logo_FA-02.png" alt="Victoria Mekong Cruise logo" width="100%" height="100%">
        </div>
        <div class="uk-width-medium-5-6" style="font-family: arial, helvetica, sans-serif;">
            <div style="padding: 0px 20px;">
                <p style="font-size: 13pt;">
                ...
                See more at
                <a href="https://victoriamekong.com" target="_blank" rel="noopener noreferrer">www.victoriamekong.com</a>
            </div>
        </div>
    </div>
</div>
