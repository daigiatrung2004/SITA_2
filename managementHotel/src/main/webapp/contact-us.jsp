...
<div class="title-contact">
    <h2 style="text-align: center"><%=lang.readXMl("contact_us")%></h2>
</div>
       ...
       <form id="frm" action="FooterControl" method="post" style="display: flex;">
        ...
        <div class="col-md-4">
             <%
               ...
               %>
           <p>Vui lòng liên hệ với chúng tôi bất kỳ lúc nào qua mẫu email bên dưới. Chúng tôi sẽ trả lời trong vòng 24 giờ làm việc.</p>

           <%
               }else{
               %>
           <p>Please feel free to contact us any time, using our email contact form. We will reply within 24 working hours.</p>
           <%
               }
               %>
           <div class="form-group">
               <label for="hotel">Khách sạn *:</label>
               <select id="hotel" name="region" class="form-control">
                   ...
                   <%}else{%>
                   <option value="<%=listRegion.get(i).getRegion_id()%>>"><%=listRegion.get(i).getName_en()%></option>
                   <%}%>
                   <%
                           }
                           }%>
           ...
           <div class="form-group">
               <label for="room">Phòng ban *:</label>
