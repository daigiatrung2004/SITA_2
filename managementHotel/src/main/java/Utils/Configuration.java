...
public class Configuration {
    ...
    public static final Map<String, String> getAcctAndConfig() {
        ...
        // Account Credential
        configMap.put("acct1.UserName", "sb-opidp1373493@business.example.com");
        configMap.put("acct1.Password", "WX4WTU3S8MY44S7F");
        configMap.put("acct1.Signature", "AQHWlkQFXe1BuWCRFmqrvRwgxL1NyVk2fBz2z_HsQfxoV-eLoKFwL7QKyv5ANO5bH5COqR7TvBiSbYZd");
